...
const programs = [
  ...
  },
  {
    ...
    title: 'Вертикаль',
    description:
      '8-тижнева онлайн-програма для постави, здорової спини та глибокої опори тіла без жорстких навантажень.',
    benefits: [
      'рівніша постава та менше скутості в шиї й спині.',
      'сильніший кор і краща опора через глибокі мʼязи.',
      'легший рух і більше розуміння тіла в побуті.',
    ],
            ...
            {programs.map((program, index) => (
              ...
              >
                ...
                <div className="prog-card-content">
                  ...
                  {program.number === '03' && (
                    <a href="/vertical" className={`prog-btn ${program.soon ? 'prog-btn-soon' : ''}`}>
                      {program.buttonLabel}
                    </a>
                  )}
                </div>
