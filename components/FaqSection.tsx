...
const faqs = [
  ...
  },
  {
    ...
    answer:
      `Наразі працюю з вагітними дівчатами та жінками в індивідуальному форматі. Ви можете приєднатися до моїх програм, якщо минуло 6 тижнів після природних пологів, після кесарева до 9 тижнів і також немає протипоказань від лікаря.

Якщо ви займалися і завагітніли — я вас вітаю! Ми можемо продовжити тренування в індивідуальному форматі.

Якщо ви ведете малорухливий спосіб життя, то приділіть більше часу тренуванням на мобільність, м’язи тазового дна та поставу.`,
  },
];
