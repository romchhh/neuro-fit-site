...
const reviews: Review[] = [
  ...
  },
  {
    ...
    text: "Після перерви у спорті боялася повертатися. Формат Neuro-Pilates виявився дуже мʼяким, але тіло швидко стало сильнішим і стійкішим.",
  },
  {
    id: 4,
    name: "Наталя, 35",
