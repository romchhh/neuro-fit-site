...
const faqsNeurofit = [
  ...
  },
  {
    ...
    answer:
      "Особливості вашого організму враховуються лише на персональному тренуванні. Під час зайняття онлайн враховуйте обмеження свого організму самостійно, попередньо проконсультувавшись із лікарем. Грижі не є протипоказанням до тренувань, якщо ви не перебуваєте в гострому запальному періоді та проходите медикаментозне лікування. При діастазі 1–2 ступеня вам необхідно тренуватися за моїми програмами. Приділіть увагу тренуванням з пілатесу. При варикозі займатися можна, але уникайте тривалого навантаження на одну з ніг і діліть кількість повторень, змінюючи ноги протягом одного підходу. Остеопороз: залежить від ступеня захворювання та наявності фізичної активності до виявлення хвороби. Якщо ви ведете активний спосіб життя і маєте описані вище проблеми, то вам можна займатися на моїх програмах. Вагітність. Післяпологове відновлення: наразі працюю з вагітними дівчатами та жінками в індивідуальному форматі. Ви можете приєднатися до моїх програм, якщо минуло 6 тижнів після природних пологів, після кесарева до 9 тижнів і також немає протипоказань від лікаря. Якщо ви займалися і завагітніли — я вас вітаю! Ми можемо продовжити тренування в індивідуальному форматі. Якщо ви ведете малорухливий спосіб життя, то приділіть більше часу тренуванням на мобільність, м'язовий тонус та поставу.",
  },
];
